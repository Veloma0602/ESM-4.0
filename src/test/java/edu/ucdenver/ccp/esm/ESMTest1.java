...
//	 */
//	/**
//	 * 为图中的每个节点生成词元和泛化POS标签，并在节点中设置相应的字段以进行节点比较过程
//	 * @param nodes : 将生成词元和泛化POS的节点
//	 */
...
//	 */
//	/**
//	 * 使用一个简单模式'conj_and(PROTEIN123-1/NNS, PROTEIN234-2/NNS)'检查子图同构能力
//	 * 请注意，令牌ID再次不同，POS标签已从'NN'更改为'NNS'
//	 * 'PROTEIN0'已替换为'PROTEIN123'，'PROTEIN1'已替换为'PROTEIN234'
//	 */
//	@Test
